            ...
            <div class="uk-width-medium-3-4">
                ...
                <div class="{modal && 'uk-overflow-container'}">
                    ...
                    <div class="uk-margin-top" if="{data && data.folders.length}">
                        ...
                        <ul class="uk-grid uk-grid-small uk-grid-match uk-grid-width-1-2 uk-grid-width-medium-1-5">
                    ...
                    <div class="uk-margin-top uk-files-container" if="{data && data.files.length}">
                        ...
                        <ul class="uk-grid uk-grid-small uk-grid-match uk-grid-width-1-2 uk-grid-width-medium-1-5" if="{ listmode=='grid' }">
                                ...
                                <div class="uk-panel uk-panel-box finder-file { file.selected ? 'uk-selected':'' }">
                                    ...
                                    <div class="uk-panel-teaser uk-cover-background uk-position-relative">
                                        <div if="{ parent.getIconCls(file) != 'image' }">
                                            <canvas class="uk-responsive-width uk-display-block" width="300" height="300"></canvas>
                                            <div class="uk-position-center"><i class="uk-text-large uk-text-muted uk-icon-{ parent.getIconCls(file) }"></i></div>
                                        </div>
                                        <cp-thumbnail src="{file.url}" width="300" height="300" if="{ parent.getIconCls(file) == 'image' }"></cp-thumbnail>
                                    </div>
